...
JAZZMIN_SETTINGS = {
    ...
    "custom_css":None,    # Path to custom CSS in static folder
...
#     {"name": "Toggle Theme", "url": "#", "new_window": False, "icon": "fas fa-adjust"},
# ]
JAZZMIN_SETTINGS["show_ui_builder"] = True
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'uvgothadiya1812@gmail.com'
EMAIL_HOST_PASSWORD = 'djjx opap pldn uslp'  # Using App Password, not regular password
DEFAULT_FROM_EMAIL = 'Bhavi India Fashion <uvgothadiya1812@gmail.com>'

# Razorpay settings
RAZORPAY_KEY_ID = os.environ.get('RAZORPAY_KEY_ID', 'rzp_test_iA4D3D8jO4XXlG')
RAZORPAY_KEY_SECRET = os.environ.get('RAZORPAY_KEY_SECRET', 'Fz6QDbYtS7cf4l3eErq8qZnr')
