...
class Coupon(models.Model):
    """
    Model representing discount coupons
    """
    ...
    discount_value = models.DecimalField(max_digits=8, decimal_places=2, help_text="Percentage or fixed amount")
    ...
    def calculate_discount(self, amount):
        ...
        if self.discount_type == 'percentage':
            ...
            return min(amount, self.discount_value)  # Can't discount more than the total
