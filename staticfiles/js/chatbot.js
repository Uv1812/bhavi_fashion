...
$(document).ready(function() {
    ...
    function getBotResponse(message) {
        ...
        if (message.includes('hello') || message.includes('hi') || message.includes('hey')) {
            ...
            return "We regularly offer promotional discounts. You can check our website banner for current offers or subscribe to our newsletter for exclusive discount codes.";
